...
export interface CustomerOrder { id:string; customer:string; location:string; zone:string; items:string; delivery:string; priority:Priority; volume:number; status:string; }
...
export interface AppState { traffic:TrafficCondition[]; orders:CustomerOrder[]; drivers:DriverCondition[]; }
