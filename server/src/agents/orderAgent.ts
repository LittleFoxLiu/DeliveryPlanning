...
export const orderTools = {
  get_order: async (orderId: string) => orders.byId(orderId),
  get_merchant: async (merchantId: string) => merchants.byId(merchantId),
  get_store: async (storeId: string) => stores.byId(storeId),
  ...
  validate_order: async (orderId: string) => {
    ...
    const [merchant, store, customer] = await Promise.all([merchants.byId(o.merchant_id), stores.byId(o.store_id), customers.byId(o.customer_id)]);
